...
SlashCmdList["MMINV"] = function(msg)
    ...
    elseif cmd == "debug" and (rest == "on" or rest == "off") then
        ...
        print("/mminv settrigger <word> - Set trigger word for auto invitation")
        print("/mminv showtrigger - Show current trigger word")
        print("/mminv debug on|off - Toggle debug logging (For developers)")
    end
end
